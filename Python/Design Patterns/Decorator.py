# -*- coding: utf-8 -*-
"""
Created on Thu Feb  9 15:52:36 2023
...
class ConcreteComponent(Component):
    '''
    Concrete Components provide default implementations of the operatoins.
...
class Decorator(Component):
    ...
    interface for all concrete decorators. The default implementation of 
    the wrapping code might include a field for storing a wrapped component 
...
class ConcreteDecoratorB(Decorator):
    '''
    Decorators can execute their behavior either before or after the 
