# -*- coding: utf-8 -*-
"""
Created on Thu Feb  9 15:21:14 2023
...
class Facade:
    ...
    def __init__(self, subsystem1: Subsystem1, subsystem2: Subsystem2) -> None:
        ...
        with existing subsystem objects or force the Facade to create them
        on its own.
        '''
...
def client_code(facade: Facade) -> None:
    ...
    interface provided by the Facade. When a facade manages the 
    lifecycle of the subsystem, the client might not even know 
    about the existence of the subsystem. This approach lets you 
