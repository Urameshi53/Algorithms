# -*- coding: utf-8 -*-
"""
Created on Sat Dec 10 04:16:32 2022
...
class ConcreteBuilder1(Builder):
    ...
    several variation of Builders, implemented differently.
    '''
    ...
    def product(self) -> Product1:
        ...
        for retrieving results. That's because various types of builder may 
        create entirely different products that don't follow the same interface.
...
if __name__ == "__main__":
    '''
    The client code creates a builder object, passes it ot the director and then initiates 
